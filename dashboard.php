				...
				<div class="card">
					<div class="card-body">
						<form action="" method="post">
							<input type="text" name="search" placeholder="Cari berdasarkan NIM" class="form-control" style="width: 25%">
							<input type="submit" name="submit" value="Cari" style="width: 25%; margin: 5px 0 0 0">
						</form>
